...
Figure* copyFig(Figure &X, int a, int b, int c, int A, int B, int C)
{
	Figure *fig = nullptr;
	try												
	{												
		fig = X.clone(a,b,c,A,B,C);		
	}												
...
Figure* copyFig(Figure &X, int a, int b, int c, int d, int A, int B, int C, int D)
{
	Figure* fig = nullptr;
	try
	{
		fig = X.clone(a, b, c, d, A, B, C, D);
	}
	catch (const BadFigure& err)
	{
		std::cout << err.what() << std::endl;
...
int main()
{
	...
	Triangle T =				Triangle();
	TriangleRight TR =			TriangleRight();
	TriangleIsosceles TI =		TriangleIsosceles();
	TriangleEquilateral TE =	TriangleEquilateral();
	...
	print_info2(copyFig(T, 10, 20, 30, 50, 60, 80));
	print_info2(copyFig(T, 10, 20, 30, 50, 60, 70));
	print_info2(copyFig(TR, 10, 20, 30, 50, 60, 70));
	print_info2(copyFig(TR, 10, 20, 30, 40, 50, 90));
	print_info2(copyFig(TI, 10, 20, 30, 50, 80, 50));
	print_info2(copyFig(TI, 10, 20, 10, 50, 90, 40));
	print_info2(copyFig(TI, 10, 20, 10, 50, 80, 50));
	print_info2(copyFig(TE, 10, 20, 30, 60, 60, 60));
	print_info2(copyFig(TE, 10, 10, 10, 50, 60, 70));
	print_info2(copyFig(TE, 10, 10, 10, 60, 60, 60));

	print_info2(copyFig(Q, 10, 20, 30, 40, 80, 80, 80, 130));
	print_info2(copyFig(Q, 10, 20, 30, 40, 80, 80, 80, 120));
	print_info2(copyFig(RE, 60, 40, 70, 40, 90, 90, 90, 90));
	print_info2(copyFig(RE, 60, 40, 60, 50, 90, 90, 90, 90));
	print_info2(copyFig(RE, 60, 40, 60, 40, 80, 100, 90, 90));
	print_info2(copyFig(RE, 60, 40, 60, 40, 90, 90, 90, 90));
	print_info2(copyFig(S, 40, 40, 40, 50, 90, 90, 90, 90));
	print_info2(copyFig(S, 40, 40, 40, 40, 80, 100, 90, 90));
	print_info2(copyFig(S, 40, 40, 40, 40, 90, 90, 90, 90));
	print_info2(copyFig(P, 40, 60, 50, 60, 80, 100, 80, 100));
	print_info2(copyFig(P, 40, 60, 40, 70, 80, 100, 80, 100));
	print_info2(copyFig(P, 40, 60, 40, 60, 85, 100, 75, 100));
	print_info2(copyFig(P, 40, 60, 40, 60, 80, 105, 80, 95));
	print_info2(copyFig(P, 40, 60, 40, 60, 80, 100, 80, 100));
	print_info2(copyFig(RO, 40, 40, 40, 50, 80, 100, 80, 100));
	print_info2(copyFig(RO, 40, 40, 40, 40, 85, 100, 75, 100));
	print_info2(copyFig(RO, 40, 40, 40, 40, 80, 105, 80, 95));
	print_info2(copyFig(RO, 40, 40, 40, 40, 80, 100, 80, 100));
